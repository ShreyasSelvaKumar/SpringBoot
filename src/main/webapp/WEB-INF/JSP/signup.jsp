...
<body>
	...
	<c:if test="${error}">
		<div><p style="color:red;margin-left:5 0px">USER ALREADY EXISTS</p></div>
		</c:if>
	<form:form class="entirearea" action="/signup" method="post"
		...
		<div class="inputs">
		     <table class="table-design">
				...
				<tr class="element">
					...
					<td class=error><form:errors path="name" name="name"
							cssClass="error" /></td>
				...
				<tr class="element">
					...
					<td class=error><form:errors path="email" name="email"
							cssClass="error" /></td>
				...
				<tr class="element">
					...
					<td class=error><form:errors path="phoneNo" name="phoneNo"
							cssClass="error" /></td>
				...
				<tr class="element">
					...
					<td class=error><form:errors path="password" name="password"
							cssClass="error" /></td>
