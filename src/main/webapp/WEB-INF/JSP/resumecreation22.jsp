...
<body>
	<form class="container" action="/resumeCreationthree" method="post"
		modelattribute="skillsandcertifications">
		<div class="title">RESUME CREATION - 2</div>
		...
		<div class="personalInfo">
				...
				<div class="personalData-row" id="skills">
					...
					<div class="data">
						<label>Have you implemented any project</label> <select
							...
							<option value="India">Yes,I have hands-on</option>
							<option value="Canada">No,But I have theoretical
								knowledge</option>
						</select>

					</div>
					<div>
						<i class="fa fa-minus-circle" onclick="deleteSkill(this)"
			...
			<div class="personalData-row" id="certificateId">
				<div class="personalData-column" id="certificates">
					<i class="fa fa-minus-circle" onclick="deleteCertificate(this)"
						style="visibility: hidden"></i>
					<div class="data">
						<label>Certificate Name</label> <input type="text"
							id="certificateName" name="certifications[0].certificateName" />
					</div>

					<div class="data">
						<label>Course Name &nbsp&nbsp&nbsp</label> <input type="text"
							id="coursename" name="certifications[0].courseName" />
					</div>

					<div class="data">
						<label>Completion link</label> <input type="text"
							name="certifications[0].certificationLink" />
					</div>
			  ...
			  div.innerHTML = `
				 ...
				 <div class="data">
					...
					<select id="implemented" >
						<option value="India">Yes,I have hands-on</option>
						<option value="Canada">No,But I have theoretical knowledge</option>
					</select>
